function [MODEL] = BoucWenRunSDOF(MODEL,Input)
...
%                   needed for the integration are assembled and the struct
%                   is given input to the Newmark integration scheme
%Returns:
%  MODEL : struct / The MODEL struct contains all system properties, 
